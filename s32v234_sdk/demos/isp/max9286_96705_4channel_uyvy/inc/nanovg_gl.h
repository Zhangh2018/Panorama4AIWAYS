...
static void glnvg__renderFill(void* uptr, NVGpaint* paint, NVGcompositeOperationState compositeOperation, NVGscissor* scissor, float fringe,
                              ...
                              NVGVertexTransformCallback vertexTransformCallback, void* vertexTransformCallbackCtx
                              )
{
	GLNVGcontext* gl = (GLNVGcontext*)uptr;
	...
	transformVertexs(gl->verts + head, maxverts, vertexTransformCallback, vertexTransformCallbackCtx);
                                   ...
                                   NVGVertexTransformCallback vertexTransformCallback, void* vertexTransformCallbackCtx)
{
	...
	transformVertexs(gl->verts + call->triangleOffset, call->triangleOffset, vertexTransformCallback, vertexTransformCallbackCtx);
